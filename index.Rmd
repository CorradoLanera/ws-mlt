---
title: "Introduction to Artificial Intelligence and Machine Learning in Supporting Clinical Decision"
...
meta() %>%
  meta_general(
    description = "Introduction to Artificial Intelligence and Machine Learning in Supporting Clinical Decision",
...
Scuola di Specialità in Fisica Medica --- University of Padova
...
```{r, echo = FALSE}
countdown(minutes = 60, warn_when = 5, play_sound = TRUE,
          left = "65%", bottom = "5%")
```
