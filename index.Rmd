...
- train classifiers with .orange[different hyper-parameters] on training data
...
(Naive) .orange[__definition:__] A large (huge...) number of highly interconnected simple processing elements (neurons) working together to solve specific problems.
...
- very little transparency (very high effort to obtain it) to what is important in the decision making process
